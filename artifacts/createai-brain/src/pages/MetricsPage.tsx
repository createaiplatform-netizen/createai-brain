...
function TotalBadge({ label, value }: { label: string; value: number }) {
  return (
    <div style={{
      ...
      borderRadius: 12, padding: "16px 20px", textAlign: "center", flex: 1, minWidth: 100,
    }}>
  ...
  return (
    <thead>
      <tr>
        {cols.map((col) => (
          <th key={col} style={{
            padding: "6px 10px 6px 0", textAlign: "left", fontSize: 11, fontWeight: 600,
...
export default function MetricsPage() {
  ...
  return (
    <div style={{ padding: "24px 24px 64px", maxWidth: 900, margin: "0 auto" }}>
      ...
      {loading && (
        <p style={{ color: TEXT_DIM, fontSize: 14, padding: "16px 0" }}>Loading…</p>
      )}
