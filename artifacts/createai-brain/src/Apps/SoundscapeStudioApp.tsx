...
function ActiveSeriesRunPanel({ series, accentColor, onBack }: { series: SoundscapeSeriesDefinition; accentColor: string; onBack: () => void }) {
...
function SeriesPanel({ onBack }: { onBack: () => void }) {
  ...
  if (activeSeries) return <ActiveSeriesRunPanel series={activeSeries} accentColor="#7c3aed" onBack={() => setActiveSeries(null)} />;
  return (
