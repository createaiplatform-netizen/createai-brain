...
const INTENT_MAP: { keywords: string[]; target: AppId }[] = [
  ...
  // ── Industry Elevation Suite — 13 sector triggers ─────────────────────────
  { keywords: ["fleet", "fleet logistics", "fleet management", "vehicles", "drivers", "shipments", "trucking", "dispatch", "fleet tracking", "logistics", "warehouses", "fuel log", "maintenance schedule", "samsara", "verizon connect"], target: "fleetLogistics" },
  { keywords: ["retail", "retail engine", "retail operations", "pos", "point of sale", "inventory retail", "products store", "promotions", "shrinkage", "retail analytics", "lightspeed", "square retail", "retail sales", "store inventory"], target: "retailEngine" },
  { keywords: ["manufacturing", "production", "work orders", "bom", "bill of materials", "quality inspection", "oee", "shop floor", "shift log", "defect rate", "factory", "production planning", "sap pp", "plex", "manufacturing ops"], target: "manufacturing" },
  { keywords: ["hospitality", "hotel", "pms", "property management system", "reservations", "rooms", "housekeeping", "check-in", "check-out", "front desk", "guest management", "f&b", "opera pms", "resort management", "occupancy"], target: "hospitality" },
  { keywords: ["energy", "utilities", "energy management", "meter readings", "consumption", "demand forecast", "outage", "sustainability kpi", "energy analytics", "osisoft", "itron", "power grid", "utility management", "energy monitoring"], target: "energyMgmt" },
  { keywords: ["real estate", "properties", "listings", "agents", "transactions", "tenants", "lease", "property management", "appfolio", "yardi", "mls", "real estate portfolio", "property listing", "rent collection", "real estate crm"], target: "realEstate" },
  { keywords: ["transportation", "rides", "trips", "passenger", "driver dispatch", "fare", "pricing zones", "ride analytics", "trip booking", "transportation management", "tripmaster", "earnings report", "safety incidents"], target: "transportation" },
  { keywords: ["nonprofit", "donors", "donations", "grants", "fundraising", "volunteers", "campaigns nonprofit", "impact", "program tracking", "bloomerang", "salesforce npsp", "donor management", "grant tracking", "charity", "501c3"], target: "nonprofit" },
  { keywords: ["construction", "projects construction", "subcontractors", "rfi", "rfis", "submittals", "daily logs", "safety incidents", "procore", "buildertrend", "change orders", "punch list", "construction management", "bids", "job site"], target: "construction" },
  { keywords: ["government", "government services", "citizen services", "permits", "permit processing", "cases government", "public contracts", "foia", "budget allocation", "public sector", "government operations", "compliance tracking government"], target: "government" },
  { keywords: ["home services", "field service", "technicians", "jobs service", "estimates", "invoices service", "servicetitan", "hvac", "plumbing", "electrical", "job scheduling", "customer portal service", "equipment service", "home repair"], target: "homeServices" },
  { keywords: ["insurance", "policies", "claims", "underwriting", "reinsurance", "agent commissions", "actuarial", "reserving", "applied epic", "policy lifecycle", "claims processing", "insurance management", "premium", "coverage insurance"], target: "insuranceMgmt" },
  { keywords: ["agriculture", "farm", "farming", "crops", "fields", "harvest", "soil health", "equipment farm", "labor farm", "yield", "market pricing farm", "subsidy", "granular", "farmlogs", "agribusiness", "planting", "crop planning"], target: "agriculture" },
];
