/**
 * BeyondInfinityConfig — frontend copy.
 * Absolute Transcendence / Beyond Infinity / Omega / Infinite+1
 *
 * Referenced by: InfiniteBrainControlPanel, InfiniteBrainVerificationPanel,
 *                Coverage Dashboard, and any panel that needs No-Limits branding.
 */
...
export const BeyondInfinityConfig = {
  ...
  frontend: {
    ...
    statusPill:  "beyond-infinity" as const,
